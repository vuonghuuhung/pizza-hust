<section class="home-slider owl-carousel img" style="background-image: url(normal/images/bg_1.jpg);">
        ...
        <div class="container">
            <div class="row slider-text align-items-center" data-scrollax-parent="true">
                ...
                <div class="col-md-6 ftco-animate">
                    <img src="normal/images/bg_1.png" class="img-fluid" alt="">
                </div>
    ...
    <div class="slider-item">
        ...
        <div class="container">
            <div class="row slider-text align-items-center" data-scrollax-parent="true">
                ...
                <div class="col-md-6 ftco-animate">
                    <img src="normal/images/bg_2.png" class="img-fluid" alt="">
                </div>
    ...
    <div class="slider-item" style="background-image: url(normal/images/bg_3.jpg);">
        <div class="overlay"></div>
        <div class="container">
...
<section class="ftco-about d-md-flex">
    <div class="one-half img" style="background-image: url(normal/images/about.jpg);"></div>
