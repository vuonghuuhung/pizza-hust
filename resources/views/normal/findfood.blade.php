    ...
    <div class="container-fluid">
        <div class="row d-md-flex">
            <div class="col-lg-4 ftco-animate img f-menu-img mb-5 mb-md-0"
                style="background-image: url(normal/images/about.jpg);">
            </div>
                    ...
                    <div class="col-md-12 nav-link-wrap mb-5">
                        <div class="nav ftco-animate nav-pills" id="v-pills-tab" role="tablist"
                            ...
                            <a class="nav-link" id="v-pills-3-tab" data-toggle="pill" href="#v-pills-3" role="tab"
                                aria-controls="v-pills-3" aria-selected="false">Side Dishes</a>

                            <a class="nav-link" id="v-pills-4-tab" data-toggle="pill" href="#v-pills-4" role="tab"
                                aria-controls="v-pills-4" aria-selected="false">Topping</a>
                        </div>
                    </div>
                                        ...
                                        <div class="col-md-4 text-center">
                                            <div class="menu-wrap">
                                                <a href="#" class="menu-img img mb-4"
                                                    style="background-image: url(foodimages/{{ $item->image }});"></a>
                                                <div class="text">
                                                    <h3><a href="#">{{ $item->name }}</a></h3>
                                                    <p>{{ $item->description }}</p>
                                                    <p class="price"><span>{{ $item->price }}</span></p>
                                                    <p><a href="{{ url('/addtocart', $item->id) }}" class="btn btn-white btn-outline-white">Add
                                                            to cart</a></p>
                                                </div>
                                            </div>
                                        </div>
