                                        ...
                                        <div class="d-flex mb-4" style="max-width: 300px">
                                            ...
                                            <div class="form-outline">
                                                <input id="form1" min="1" name="quantity" value="{{ $item->quantity }}"
                                                    type="number" class="form-control text-dark" />
                ...
                <div class="col-md-4">
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <button type="button" onclick="document.getElementById('order').scrollIntoView();" class="btn btn-primary btn-lg btn-block">
                                Make Order
                            </button>
                        </div>
                    </div>
        ...
        <div class="container-wrap align-items-center">
            <div class="row no-gutters d-md-flex align-items-center">
                <div class="col-md-6 appointment ftco-animate" style="margin-left: 37rem">
                    ...
                    <form action="{{ url('/makeorder') }}" class="appointment-form" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="d-md-flex">
